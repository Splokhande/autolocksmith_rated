...
class DashBoardWidget extends StatelessWidget {
  ...
  DashBoardWidget({this.container1, this.container2, this.widget, this.header,this.currentPage, this.shop, this.onTap});
  double height, width;
  List<Lead> newLeads = [];
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: WhiteHeadTextWidget(text: header,
                 ...
                 Padding(
                   ...
                   child: ListTile(
                     ...
                     title: Padding(
                       ...
                       child: Text("Hello ${shop.shopContactPerson}",
                                    style: TextStyle(color: Theme.of(context).primaryColor,fontSize: width*0.035,
                                                                      fontWeight: FontWeight.bold),),
                     ),
                     trailing: IconButton(icon:Icon(Icons.arrow_forward_ios_sharp,size: width*0.045,),onPressed: (){
                       Navigator.of(context).pop();
                     },),
                   ),
                 ),
                  ...
                  GestureDetector(
                      ...
                      child: DrawerItems(text: "Dashboard",isOpen: currentPage =="Dashboard",)),
                  ...
                  GestureDetector(
                      ...
                      child: DrawerItems(text: "Leads",isOpen:currentPage =="Leads" ,)),
                  Divider(color: Colors.grey,),
                   ...
                   GestureDetector(
                       ...
                       child: DrawerItems(text: "Profile",isOpen: currentPage =="Profile",)),
                  Divider(color: Colors.grey,),
                  ...
                  GestureDetector(
                      ...
                      child: DrawerItems(text: "Logout",isOpen: false,)),
                  Divider(color: Colors.grey,),
                ],
              ),
            ),
          ...
          body:ChangeNotifierProvider(
            ...
            child:Consumer<LeadsDetail>(
                builder: (context,lead,widges) {
                return Column(
...
class LeadBoardWidget extends StatelessWidget {
  ...
  Function onTap;
  final String currentPage;
  LeadBoardWidget({this.container2,this.currentPage, this.widget, this.header, this.shop, this.onTap});
  double height, width;
  List<Lead> newLeads = [];
  List<Lead> submittedLeads=[];
  API api = API();
              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  bottom: PreferredSize(
                    preferredSize: Size(width, 0.5.sh,),
                    child: widget == null? Container():
                    Padding(
